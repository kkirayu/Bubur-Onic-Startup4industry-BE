...
class BonusKaryawanTest extends TestCase
{
    ...
    public function hapusBonusKaryawan()
    {
        $user = UserFactory::new()->create();
        $team = Team::create([
            "nama" => "TestTeam",
        ...
        $response = $this->json('DELETE', "api/pegawai/bonus-karyawan/delete/{$bonus->id}");

        $response->assertStatus(200)
        ->assertJson(['message' => 'Bonus Karyawan berhasil dihapus']);
    }
}
